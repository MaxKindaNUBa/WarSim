...
def start_run(run_name, config):
    """Create runs/<run_name>_<timestamp>/, wire up run.log + console logging
    and a tensorboard SummaryWriter, and snapshot the fully-resolved config.
